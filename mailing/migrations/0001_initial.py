# Generated by Django 4.2.2 on 2024-08-09 13:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('created', 'создана'), ('started', 'запущена'), ('completed', 'завершена'), ('disabled', 'отключена')], default='created', max_length=10, verbose_name='статус')),
            ],
            options={
